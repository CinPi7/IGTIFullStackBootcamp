    ...
    readInput.question("Qual o UF? ", sigla => {
        ...
        async function init(sigla){
            ...
            try{
                ...
                //console.log(biggest);   
                //console.log( States with more cities: ',biggest.slice(0,5));
                ...
                // console.log('All states mentioned', small);   
                console.log('States with the fewest cities: ' , small.slice(0,5));
